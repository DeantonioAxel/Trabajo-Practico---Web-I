export const cursoAIMarketingDigital = {
    ...
    descripcion: [
        ...
        "Al finalizar, podrás implementar estrategias digitales apoyadas en la IA para redes sociales, email marketing, publicidad online y análisis predictivo."
    ],
    requisitos: {
        conocimientos: [
            "Conocimientos básicos de marketing digital.",
            "Familiaridad con redes sociales y campañas publicitarias online."
        ],
        tecnicos: [
            "Una computadora con acceso a internet.",
            "Cuenta en herramientas de marketing digital (Google Ads, Meta Ads, etc.).",
    ...
    docente: {
        nombre: "Laura Gómez",
        estrellas: 5,
        descripcion: "Laura es especialista en marketing digital y consultora en transformación digital con IA. Ha trabajado con agencias y marcas internacionales en la implementación de estrategias digitales innovadoras basadas en inteligencia artificial."
    }
};