export class HeaderHome {
    ...
    render() {
        ...
        const longitudDeCursos = cursosDelUsuario.length;
        ...
        if (usuarioLogueado) {
            botones.innerHTML = `
                <div class="shoppingCart">
                    ...
                    <p class="cantidadDeCursos">${longitudDeCursos}</p>
                </div>
        ...
        if (btnCarrito) {
            ...
            btnCarrito.addEventListener('click', () => {
                ...
                sidebar.innerHTML = `
                    ...
                    ${longitudDeCursos > 0 ? '<div class="cursosDelSidebar"></div>' : '<p>Todavía no se obtuvieron cursos</p>'}
                `;

                
                const btnCerrarSidebar = sidebar.querySelector('.cerrar-sidebar');
